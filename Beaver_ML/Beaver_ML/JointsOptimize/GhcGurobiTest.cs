...
namespace Beaver.Components.Optimization
{
    public class GhcGurobiTest : GH_Component
    {
        ...
        public GhcGurobiTest()
            : base("GurobiTest_ML", "GurobiTest", "GurobiTest测试", "Beaver", "Optimization")
        {
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Resources.Gurobi_BeaverIcon;
            }
        }
        ...
        public override Guid ComponentGuid
        {
            get
            {
                return new Guid("a1cb546a-2030-4d23-b439-144fd443f1cd");
            }
        }
    }
}
